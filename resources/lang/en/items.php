...
return [
    ...
    'title_min' => 'The number of characters in the title field must be at least :min',
    'content_min' => 'The number of characters in the description field must be at least :min',
    'title_max' => 'The number of characters in the title field can not exceed :max',
    'content_max' => 'The number of characters in the description field can not exceed :max',
    ...
    'stock_required' => 'Amount field is required',
    'stock_numeric' => 'The value of amount field must be a number',
    'stock_digits_between' => 'Amount digits should be between :min and :max',

    // Views
    'type' => 'Type',
    'all_amount_1' => 'In stock:',
    'all_amount_2' => 'pcs.',
    'hryvnia' => 'UAH',
    'name' => 'Title',
    'order' => 'Order',
    ...
    'go_to_product' => 'Go to a product',
    'save_item' => 'Save changes',
    'go_to_product_with_title' => 'Go to a :title',
    'code_of_the_item' => 'Product code:',
    ...
    'select_price' => 'Enter price without change',
