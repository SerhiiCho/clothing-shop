...
<div class="container pb-5">
	...
	<div>
		<img src="{{ asset('/storage/img/slider/' . $slider->image) }}" class="rounded mx-auto d-block" id="target-image">
	</div>
	<div class="col-md-8 offset-md-2">

		<form action="{{ action('SliderController@update', ['slider' => $slider->id]) }}" method="post" enctype="multipart/form-data" class="row">
		...
		{{-- Delete button --}}
		<form action="{{ action('SliderController@destroy', ['slider' => $slider->id]) }}" method="post" onsubmit='return confirm("@lang('slider.are_you_sure')")' class="my-2 row">
