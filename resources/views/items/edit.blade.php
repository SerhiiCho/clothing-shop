...
<div class="container pb-4 col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
	...
	<div class="row">
		<form action="{{ action('ItemController@update', ['id' => $item->id]) }}" method="post" enctype="multipart/form-data" class="col-md-6 col-lg-8">
			...
			<button type="submit" class="btn btn-dark mt-3">@lang('items.change_item')</button>
		</form>

		<div class="col-md-6 col-lg-4 mt-3">
			<img src="{{ asset('/storage/img/clothes/' . $item->image) }}" alt="{{ $item->title }}" class="rounded mx-auto d-block" id="target-image" style="width: 300px; height:380px;">
		</div>
	</div>
</div>
